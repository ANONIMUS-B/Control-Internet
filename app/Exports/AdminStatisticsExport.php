 ...
 */
class StatisticsSummarySheet implements FromArray, WithTitle, WithStyles, ShouldAutoSize
{
    protected ?int $month;
 ...
 */
class InstitutionsWithoutReportSheet implements FromCollection, WithTitle, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected ?int $month;
 ...
 */
class PendingReportsSheet implements FromCollection, WithTitle, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    protected ?int $month;
