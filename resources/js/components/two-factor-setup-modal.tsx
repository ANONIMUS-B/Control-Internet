    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La autenticación de dos factores ya está activada. Escanea el código QR o ingresa la clave en tu app autenticadora.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para completar la activación de 2FA, escanea el código QR o ingresa la clave en tu app autenticadora',
            buttonText: 'Continuar',
        };
